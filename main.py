...
message = [SystemMessagePromptTemplate(prompt=PromptTemplate(input_variables=['question'], template="""
    You are a helpful agent, you are here to help the user solve the problem. 
    You are not a calculator or a  
    Logically arrive at the solution, and be factual. 
    In your answers, clearly detail the steps involved.
    Calculate step by step with the calculator
    After the reasoning give the final answer. Provide the response in bullet points. 
...
agent = setup_openai_agent(llm,[math_tool, word_problem_tool],prompt)

#print(agent.invoke(
#    {"question": """You have a fruit basket containing 5 different types of fruit: apples, oranges, bananas, grapes, and kiwis.
#
#Here's the scenario:
#
...
#
#Question: How many pieces of fruit are there in each of the updated fruit baskets, and how many pieces of each type of fruit do you have left over?"""
#     }))